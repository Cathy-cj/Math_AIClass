...
```bash
npm run course:new -- sum-6-21-5star "六之二十一·5星"
npm run course:new -- --from-md ../path/sum-6-21-5star.md "六之二十一·5星"
npm run course:new -- ../path/sum-6-21-5star.md "六之二十一·5星"
```
