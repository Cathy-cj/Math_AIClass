...
| [`courses/`](courses/) | 包 | 课件源：`course.json`、课专属模块 / Figure |
...
任意 Agent 先读 **[`AGENTS.md`](AGENTS.md)** 与 **[`skills/`](skills/)**。人读总览见 **[`docs/production/`](docs/production/)**：一次只推进一门课；主路径为大纲 → 讲法 → 编排 → 预览（可选导出）。**暂不含** Tag / Release。
...
| 绘图（JSXGraph 2D/3D） | [`docs/production/figure-tooling.md`](docs/production/figure-tooling.md) |
