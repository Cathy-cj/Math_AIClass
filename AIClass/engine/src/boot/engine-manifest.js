...
;(function () {
  window.AICLASS_ENGINE_MANIFEST = [
    ...
    // figures — JSXGraph 2D/3D，再 registry；kit.js 为 legacy SVG
    'figures/jxg-loader.js',
    'figures/jxg-kit-2d.js',
    'figures/jxg-kit-3d.js',
    'figures/view3d-animate.js',
    'figures/kit.js',
    'figures/registry.js',
